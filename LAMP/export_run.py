'''
Script to be ran from command line.
...
### Run with flag specifying the run number to export ###

parser = argparse.ArgumentParser()
parser.add_argument('--run', '-r', 
                    type=str, 
                    help='The runid number for the run to be exported.'
                    )
...
URI='mssql+pyodbc://SA:Domeli1947!@192.168.166.54/Lamp_dev?Driver=ODBC Driver 17 for SQL Server'
...
### Export as Excel Workbook ###
    ...
    filename = (str(currentdir) + '/LAMP_export_run_' + str(run_id) + '.xlsx')
